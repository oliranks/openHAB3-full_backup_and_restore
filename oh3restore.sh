...
#sudo mkdir -v "$BACKUPDIR$RESTOREFILE/openhab";
#echo -e "Creating influxdb backup directory:";
#sudo mkdir -v "$BACKUPDIR$RESTOREFILE/influxdb";
#echo -e "Creating grafana backup directory:";
#sudo mkdir -v "$BACKUPDIR$RESTOREFILE/grafana";
echo -e ""
...
#echo -e "Grafana backup restored \e[32msucessfully\e[0m.";
echo -e "";

echo -e "\e[96m############################\e[0m";
echo -e "\e[96m##### \e[31mInfluxdb Restore \e[96m#####\e[0m";
echo -e "\e[96m############################\e[0m";
#echo -e "Deleting old DB $INFLUXDB...";
#sudo influx -database 'openhab' -username 'admin' -password $INFLUXPW -execute "DROP DATABASE $INFLUXDB"
#echo -e "Stopping influxdb server...";
#sudo systemctl stop influxdb
#echo -e "Influxdb server \e[31mstopped\e[0m.";
...
#sudo influxd restore -portable "$BACKUPDIR$RESTOREFILE/influxdb/";
...
#echo -e "Influxdb backup restored \e[32msucessfully\e[0m.";
echo -e "";
