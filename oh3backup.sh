...
if [[ $EUID -ne 0 ]]; then
echo -e "\e[96m################################################\e[0m"
echo -e "\e[96m##### \e[31mopenHAB3 FULL Backup Script v0.1     \e[96m#####\e[0m"
echo -e "\e[96m################################################\e[0m"
...
echo -e "Usage: sudo ./oh3backup.sh"
   exit 1
fi
...
#echo -e "Grafana backup created \e[32msucessfully\e[0m."
echo -e ""
...
#sudo influxd backup -portable "$BACKUPDIR$BACKUPNAME-$TIMESTAMP/influxdb/"
...
#echo -e "Influxdb backup created \e[32msucessfully\e[0m."
echo -e ""
